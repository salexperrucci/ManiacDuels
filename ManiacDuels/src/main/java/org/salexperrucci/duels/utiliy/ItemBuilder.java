...
public class ItemBuilder {
    ...
    public ItemBuilder setLore(String... lore){
        ItemMeta im = is.getItemMeta();
        im.setLore(Arrays.stream(lore).map((string) -> ChatColor.translateAlternateColorCodes('&', string)).collect(Collectors.toList()));
        is.setItemMeta(im);
        return this;
    }
    /**
    ...
    public ItemBuilder setLore(List<String> lore) {
        ItemMeta im = is.getItemMeta();
        im.setLore(lore.stream().map((string) -> ChatColor.translateAlternateColorCodes('&', string)).collect(Collectors.toList()));
        is.setItemMeta(im);
        return this;
    }
    /**
